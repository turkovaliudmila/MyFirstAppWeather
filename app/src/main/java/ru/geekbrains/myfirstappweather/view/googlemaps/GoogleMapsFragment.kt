package ru.geekbrains.myfirstappweather.view.googlemaps
...
import ru.geekbrains.myfirstappweather.databinding.FragmentGoogleMapsBinding
...
class GoogleMapsFragment : Fragment() {
    ...
    private fun addMarkerToArray(location: LatLng) {
        val marker = setMarker(location, markers.size.toString(), R.drawable.ic_gps_fixed)
        markers.add(marker)
    }
    ...
    private fun goToAddress(
        ...
        view.post {
            setMarker(location, searchText, R.drawable.ic_map_course)
            map.moveCamera(
